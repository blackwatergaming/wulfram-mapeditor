...
Download [Wulfram Forge v0.5.0](https://github.com/blackwatergaming/wulfram-mapeditor/releases/tag/v0.5.0), extract the ZIP, and run `WulframForge/WulframForge.exe`. Node.js and a local web server are not required for the desktop build.
